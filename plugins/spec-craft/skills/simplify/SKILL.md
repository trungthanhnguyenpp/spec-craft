---
name: simplify
description: Code review and cleanup pass over the current diff. Launches three parallel review agents (reuse, quality, efficiency) over changed files, then fixes the findings directly. Use on "/simplify", or when the user says "simplify", "clean up the diff", "review and tidy", "look for hacks", or "tighten this up" after writing code. Skip for greenfield design discussions or when there are no recent code changes to review.
---
